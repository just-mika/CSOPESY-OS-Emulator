...
void Process::initializeCommands(int limit)
{
	...
	std::vector<std::shared_ptr<ICommand>> initialCommands = demoCase(this->pID, this->name, limit, 1);
		//generateCommandBlock(this->pID, this->name, limit, 1); // Add 1 for command loop depth
